export default {
  ...
  home: {
    welcome: "Üdvözöllek",
    name: "Kaselyák Bence",
    role: "Webfejlesztő és szoftvertesztelő",
  ...
  about: {
    ...
    close: "Bezárás",
    tabs: {
      professional: "Szakmai tapasztalat",
      academic: "Tanulmányok",
  ...
  skills: {
    ...
    groups: {
      programming: "Programozási nyelvek és eszközök",
      frontend: "Frontend fejlesztés",
      backend: "Backend fejlesztés",
      testing: "Szoftvertesztelés",
      languages: "Nyelvek",
    },
  },
  projects: {
